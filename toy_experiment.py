...
def get_args():
    ...
    parser.add_argument('--model-type', type=str, required=True, choices=['attention_mil', 'transmil', 'additive_mil', "conjunctive_mil", "adjunctive_mil"])
...
def main():
    ...
    collate_fn = bag_collate_fn if args.model_type in ['attention_mil', 'additive_mil', "conjunctive_mil", "adjunctive_mil"] else None
